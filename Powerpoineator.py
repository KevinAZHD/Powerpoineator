...
# Solicita al usuario el tema de la presentación

nuevo_string = input("¡HOLA! Por favor escriba de lo que quiera tratar su PowerPoint: ")
print(nuevo_string)

# Función para extraer el contenido entre llaves en un texto
...
# Define tu token de la API del Replicate
...
# Función para intentar obtener una respuesta válida del modelo
...
# Intenta obtener una respuesta válida del modelo

respuesta = intentar_obtener_respuesta()

# Si no se obtuvo una respuesta válida, espera un tiempo y vuelve a intentarlo
...
# Ahora puedes usar esa 'tupla' para tu presentación
...
for section, content in sections.items():
    ...
    # Define el input para la función run del Replicate
...
# Define los diseños de las diapositivas
